...
class PurchaseController(
    ...
    fun purchase(@RequestBody @Valid request: PostPurchaseRequest, authentication: Authentication){
        purchaseService.create(purchaseMapper.toModel(request, authentication))
    }
